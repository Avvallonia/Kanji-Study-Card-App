...
Прогрессивное веб-приложение (PWA) для изучения японских кандзи всех уровней JLPT (N5–N1).
...
- 📕 **481 кандзи из Basic Kanji Book** — с примерами в книжном формате и русскими переводами
...
### Android (Chrome)
1. Открой [ссылку на приложение](https://ТВОЙ_НИК.github.io/kanji-study/)
